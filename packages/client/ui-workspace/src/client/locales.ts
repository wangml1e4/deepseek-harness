...
export const zh = {
  ...
  'delete.desc': '将把“{name}”从工作区列表中移除。文件夹与会话记录会保留，其会话将显示在“未分组”下。必须先把活动和已归档的 Taskboard Issue 全部移动到其他工作区。',
...
export const en = {
  ...
  'delete.desc': 'This removes “{name}” from the workspace list. The folder and session logs will be kept. Its sessions will appear under Ungrouped. Move every active and archived Taskboard Issue to another workspace first.',
