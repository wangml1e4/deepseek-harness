...
export function apply(ctx: ClientContext): void {
  ...
  const injected = (): TaskboardInjected => ({
    ...
    addAttachment: file => controller.addAttachment(file, USER_ACTOR),
    readAttachment: attachment => controller.readAttachment(attachment),
    deleteAttachment: (attachment, confirmed) => controller.deleteAttachment(attachment, confirmed, USER_ACTOR),
