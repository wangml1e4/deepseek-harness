...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  taskboardPatrol: 'taskboard.md',
  taskboardRemote: 'taskboard.md',
  jobs: 'jobs.md',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  WorkspaceDeleteGuard: 'workspace.md',
  ...
  Activity: 'taskboard.md',
  AddAttachmentInput: 'taskboard.md',
  AddCommentInput: 'taskboard.md',
  AddIssueRelationInput: 'taskboard.md',
  BindPatrolDevelopmentContextInput: 'taskboard.md',
  BeginPatrolRunInput: 'taskboard.md',
  ClaimPatrolIssueInput: 'taskboard.md',
  Comment: 'taskboard.md',
  CompletePatrolAttemptInput: 'taskboard.md',
  CompletePatrolRunInput: 'taskboard.md',
  CreateIssueInput: 'taskboard.md',
  DeleteAttachmentInput: 'taskboard.md',
  ...
  IssueRelationMutation: 'taskboard.md',
  ListIssuesInput: 'taskboard.md',
  MoveIssueInput: 'taskboard.md',
  RemovePatrolWorktreeInput: 'taskboard.md',
  PatrolAttempt: 'taskboard.md',
  ...
  PatrolPolicyDefaults: 'taskboard.md',
  PatrolReview: 'taskboard.md',
  PatrolRun: 'taskboard.md',
  PatrolRunId: 'taskboard.md',
  PatrolWorktreeRemoval: 'taskboard.md',
  RecordPatrolReviewInput: 'taskboard.md',
  ReadAttachmentInput: 'taskboard.md',
  RemoveIssueRelationInput: 'taskboard.md',
  SetWorkspacePrefixInput: 'taskboard.md',
  UpdateIssueInput: 'taskboard.md',
  UpdatePatrolPolicyInput: 'taskboard.md',
  VersionedIssueInput: 'taskboard.md',
  WorkspaceTaskboard: 'taskboard.md',
  TaskboardActivityListValue: 'taskboard.md',
  TaskboardAttachment: 'taskboard.md',
  TaskboardAttachmentContent: 'taskboard.md',
  TaskboardAttachmentContentValue: 'taskboard.md',
  TaskboardAttachmentId: 'taskboard.md',
  TaskboardAttachmentListValue: 'taskboard.md',
  TaskboardAttachmentMutation: 'taskboard.md',
  TaskboardAttachmentReadInput: 'taskboard.md',
  TaskboardAttachmentUploadInput: 'taskboard.md',
  TaskboardCommentListValue: 'taskboard.md',
  TaskboardIssueListValue: 'taskboard.md',
  TaskboardIssueValue: 'taskboard.md',
  TaskboardRelationListValue: 'taskboard.md',
  TaskboardPatrolIssueValue: 'taskboard.md',
  TaskboardPatrolTriggerInput: 'taskboard.md',
  TaskboardPatrolValue: 'taskboard.md',
  TaskboardPatrolWorktreeRemovalInput: 'taskboard.md',
  TaskboardPatrolWorktreeRemovalValue: 'taskboard.md',
