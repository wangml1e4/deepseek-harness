...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-taskboard': { kind: 'none', reason: 'Browser-side Taskboard projection and mutation controls; registers nothing model-facing.' },
  ...
  'packages/client/ui-settings-token-usage': { kind: 'none', reason: 'Browser-side persisted-usage projection; registers nothing model-facing.' },
