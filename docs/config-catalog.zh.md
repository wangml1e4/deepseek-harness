...
来源：[`packages/taskboard/taskboard-patrol/src/index.ts:89`](../packages/taskboard/taskboard-patrol/src/index.ts)
...
来源：[`packages/taskboard/taskboard-sqlite/src/index.ts:107`](../packages/taskboard/taskboard-sqlite/src/index.ts)
...
来源：[`packages/llm/token-meter/src/types.ts:15`](../packages/llm/token-meter/src/types.ts)
...
- `@deepseek-ai/dsh-client-ui-taskboard`（[`packages/client/ui-taskboard/src/index.ts`](../packages/client/ui-taskboard/src/index.ts)）
...
- `@deepseek-ai/dsh-skill-manage-taskboard` — 需要 `skills`（[`packages/taskboard/skill-manage-taskboard/src/index.ts`](../packages/taskboard/skill-manage-taskboard/src/index.ts)）
...
- `@deepseek-ai/dsh-taskboard` — 抽象 `TaskboardService`（[`packages/taskboard/taskboard/src/index.ts`](../packages/taskboard/taskboard/src/index.ts)）
...
- `@deepseek-ai/dsh-taskctl`（[`packages/taskboard/taskctl/src/index.ts`](../packages/taskboard/taskctl/src/index.ts)）
