...
| --- | --- | --- | --- | --- | --- | --- |
| `ctx.taskboard` | `seam` | [`taskboard`](../packages/taskboard/taskboard) | [`taskboard-sqlite`](../packages/taskboard/taskboard-sqlite) | - | - | The Service Definition owns Workspace-scoped Issues and append-only history; the local Provider commits those records in one Host-owned SQLite database. |
