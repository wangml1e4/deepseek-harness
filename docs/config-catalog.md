...
Source: [`packages/taskboard/taskboard-patrol/src/index.ts:89`](../packages/taskboard/taskboard-patrol/src/index.ts)
...
Source: [`packages/taskboard/taskboard-sqlite/src/index.ts:107`](../packages/taskboard/taskboard-sqlite/src/index.ts)
...
Source: [`packages/llm/token-meter/src/types.ts:15`](../packages/llm/token-meter/src/types.ts)
...
- `@deepseek-ai/dsh-skill-manage-taskboard` — requires `skills` ([`packages/taskboard/skill-manage-taskboard/src/index.ts`](../packages/taskboard/skill-manage-taskboard/src/index.ts))
